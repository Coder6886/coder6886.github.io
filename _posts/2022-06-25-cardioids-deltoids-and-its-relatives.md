...
由于$点B$是定点，而且是无滑动滚动，所以$|\overset{\huge\frown}{B'E}|=|\overset{\huge\frown}{BE}|$

![cardioids-deltoids-and-its-relatives-fig3](/img/cardioids-deltoids-and-its-relatives-fig3.png)

由于$\angle EAB=\omega（弧度）$，并且$AB=r$，所以$|\overset{\huge\frown}{BE}|=\omega r$，所以$|\overset{\huge\frown}{B'E}|=\omega r$，又由于$C'B'=1$，所以$\angle EC'B'=\frac{\omega r}{1}=\omega r$。
