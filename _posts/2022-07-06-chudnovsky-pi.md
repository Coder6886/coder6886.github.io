...
=\frac{1}{426880\sqrt{10005}}\sum_{n=0}^{\infty}\frac{(-1)^n(6n)!(13591409+545140134n)}{(3n)!(n!)^3640320^{3n}}
...
P(m,n)=\prod_{k=m}^{n-1}p_k

$$

$$

Q(m,n)=\prod_{k=m}^{n-1}q_k

$$

$$

B(m,n)=\prod_{k=m}^{n-1}b_k
...
B(m,n) = B(m,l)B(l,n)\quad(m\leq l\leq n)
